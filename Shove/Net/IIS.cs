...
//        public IIS(string hostName, string userName, string password)
//        {
//            HostName = hostName;
//            UserName = userName;
//            Password = password;
...
//        /// <summary>
//        ///  根据是否有用户名来判断是否是远程服务器。
//        ///  然后再构造出不同的 DirectoryEntry
//        /// </summary>
//        /// <param name="EntryPath">DirectoryEntry的路径</param>
//        /// <returns>返回的是DirectoryEntry实例</returns>
//        private DirectoryEntry GetDirectoryEntry(string EntryPath)
//        {
