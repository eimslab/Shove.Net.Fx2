...
namespace Shove._Net.Mail
{
    public class POP3 : TcpClient
    {
        ...
        public bool getMailServer()
        {
            ...
            {
                //域名解析 
                System.Net.IPAddress ipaddress = (System.Net.IPAddress)System.Net.Dns.Resolve(strServer).AddressList.GetValue(0);
        ...
        public int getMailCount()
        {
            ...
            {
                return Convert.ToInt16(strRet.Split(" ".ToCharArray())[1]);
        ...
        {
            if (!OperaStream("DELE " + Convert.ToSingle(mIndex), "+OK"))
            {
                return false;
            }
            return true;
