...
namespace Shove.Alipay
{
    ...
    public class Alipay
    {
        private string PartnerID = "2088101xxxxxxxxxx";
        private string PartnerKey = "xxxxxxxxxxxxxxxxxxxxxxxxx";
        private string ServicesAccount = "alipay_cn_service@yahoo.com";
        ...
        public void SetOption(string CallCert, string OptionValue)
        {
            ...
            try
            {
                string[] strs = _Security.Encrypt.UnEncryptString(GetCallCert(), OptionValue.Substring(32, OptionValue.Length - 32)).Split(',');

                PartnerID = strs[0];
                PartnerKey = strs[1];
                ServicesAccount = strs[2];
                FormalitiesFees = _Convert.StrToDouble(strs[3], 0.01);
            }
            catch
            {
            }
        ...
        private bool CheckOptonValue(string OptionValue)
        {
            ...
            try
            {
                OptionValue = _Security.Encrypt.UnEncryptString(CallCert, OptionValue);
            }
            catch
            {
                return false;
        ...
        /// <param name="CallCert"></param>
        /// <param name="OptionValue"></param>
        public void SetOptionForMySQL(string CallCert, string OptionValue)
        {
            if (CallCert != GetCallCert())
            {
                throw new Exception("Call fail.");
        ...
        params string[] ParamsAndValue)
        {
            ...
            try
            {
                Tmptotal_fee = Convert.ToDouble(total_fee);
            }
            catch
            {
                return "";
    ...
    public class AlipayCommon
    {
        ...
        public static string GetFileMD5(string fileName)
        {
            ...
            foreach (byte b in result)
            {
                ...
                string temp = ("0" + Convert.ToString(b, 16));
