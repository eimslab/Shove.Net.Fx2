...
namespace Shove.Database.Persistences
{
    ...
    public class MSSQL
    {
        ...
        public string Generation_CLR()
        {
            ...
            string Result = Shove.Properties.Resources.CLT_MasterCode;

            StringBuilder sb = new StringBuilder();
            Tables(ref sb, true);
            Result = Result.Replace("/*[$Replace_Tables$]*/", sb.ToString());

            sb = new StringBuilder();
            Views(ref sb, true);
            Result = Result.Replace("/*[$Replace_Views$]*/", sb.ToString());

            if (m_NamespaceName != "")
            {
                Result = Result.Replace("namespace Shove.CLR", "namespace " + m_NamespaceName);
            }
