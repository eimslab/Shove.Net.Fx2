...
{	
	...
	/// by stepping through action lists and following branches. In opposite to <see cref="SwfDotNet.IO.ByteCode.CodeWalker"/>
	...
	public class CodeTraverser {		
		...
		/// <summary>
		/// ArrayList of action objects derived from <see cref="SwfDotNet.IO.ByteCode.Actions.BaseAction"/>.
		/// </summary>
