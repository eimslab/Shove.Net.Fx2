...
{	
	...
	public class ActionNewObject : BaseAction {		
	
		/// <summary>
		/// constructor
		/// </summary>
		public ActionNewObject():base(ActionCode.NewObject)
		{
		}
		...
		/// <summary>
		/// argument count found by <see cref="SwfDotNet.IO.ByteCode.InvocationExaminer">InvocationExaminer</see>
		/// </summary>
		public int NumArgs {
			set {
				numArgs = value;
