...
namespace SwfDotNet.IO.ByteCode.Actions
{
	...
	public class ActionGotoLabel : MultiByteAction {
		...
		/// constructor
		/// </summary>
		public ActionGotoLabel(string l):base(ActionCode.GoToLabel)
		{
			label = l;
		}
		...
		public override int ByteCount {
			get {
				return 3+label.Length+1;
			}
		}
		
		/// <summary>overriden ToString method</summary>
		public override string ToString() {
			return String.Format("gotoLabel '{0}'",label);
		}
...
{
			base.Compile(w);
			BinaryStringRW.WriteString(w,label);
		}
	}
}
