...
namespace SwfDotNet.IO.ByteCode.Actions
{
	...
	public class ActionInstanceOf : BaseAction {
		
		/// <summary>
		/// array count as found by <see cref="SwfDotNet.IO.ByteCode.InvocationExaminer">Invocation Examiner</see>
		/// </summary>
		public ActionInstanceOf():base(ActionCode.InstanceOf)
		{
		}
