...
{		
	...
	public class ActionInitObject : BaseAction {		

		/// <summary>
		/// constructor
		/// </summary>
		public ActionInitObject():base(ActionCode.InitObject)
		{
		}
		...
		/// <summary>
		/// property count as found by <see cref="SwfDotNet.IO.ByteCode.InvocationExaminer">Invocation Examiner</see>
		/// </summary>
		public int NumProps {
			set {
				numProps = value;
