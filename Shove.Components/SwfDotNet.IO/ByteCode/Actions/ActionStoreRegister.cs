...
namespace SwfDotNet.IO.ByteCode.Actions
{
	...
	/// </summary>
	public class ActionStoreRegister : MultiByteAction {
		
		/// <summary>
		/// register number
		/// </summary>
		public byte Register; // register number
		
		/// <summary>
		/// constructor
		/// </summary>
		/// <param name="r">register number</param>
		public ActionStoreRegister(byte r):base(ActionCode.StoreRegister)
		{
			Register = r;
		}
		...
		public override void Compile(BinaryWriter w) 
{
		...
		public override string ToString() {
			return String.Format("set r:{0}",Register);
		}		
	}
}
