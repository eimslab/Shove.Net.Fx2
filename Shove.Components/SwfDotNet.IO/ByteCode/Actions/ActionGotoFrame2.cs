...
namespace SwfDotNet.IO.ByteCode.Actions
{
	...
	public class ActionGotoFrame2 : MultiByteAction {
		
		private byte[] gotoData;
		
		/// <summary>
		/// constructor
		/// </summary>
		public ActionGotoFrame2(byte[] data):base(ActionCode.GotoFrame2)
		{				
			gotoData = data;			
		}
