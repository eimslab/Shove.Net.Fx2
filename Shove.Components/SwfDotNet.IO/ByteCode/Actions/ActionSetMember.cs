...
{		
	...
	public class ActionSetMember : BaseAction {		
	
		/// <summary>
		/// constructor
		/// </summary>
		public ActionSetMember():base(ActionCode.SetMember)
		{
		}

		/// <see cref="SwfDotNet.IO.ByteCode.Actions.BaseAction.PopCount"/>
		public override int PopCount { get { return 3; } }
		...
		public override string ToString() {
			return String.Format("setMember");
		}
	}
}
