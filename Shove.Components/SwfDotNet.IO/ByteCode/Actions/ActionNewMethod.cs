...
{		
	...
	public class ActionNewMethod : BaseAction {		
		
		/// <summary>
		/// constructor
		/// </summary>
		public ActionNewMethod():base(ActionCode.NewMethod)
		{
		}
		...
		/// <summary>
		/// number of arguments found by <see cref="SwfDotNet.IO.ByteCode.InvocationExaminer">InvocationExaminer</see>
		/// </summary>
		public int NumArgs {
			set {
				numArgs = value;
