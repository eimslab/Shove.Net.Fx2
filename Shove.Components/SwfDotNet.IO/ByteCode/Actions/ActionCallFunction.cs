...
namespace SwfDotNet.IO.ByteCode.Actions 
{
	...
	public class ActionCallFunction : BaseAction {
		
		/// <summary>
		/// constructor
		/// </summary>
		public ActionCallFunction():base(ActionCode.CallFunction)
		{
		}
		...
		/// <summary>
		/// argument count as found by <see cref="SwfDotNet.IO.ByteCode.InvocationExaminer"></see>
		/// </summary>
		public int NumArgs {
			set {
				numArgs = value;
		...
		public override string ToString() {
			return String.Format("callFunction ({0} args)",numArgs);
		}
	}	
}
