...
namespace SwfDotNet.IO.ByteCode
{
	...
	///  of <see cref="SwfDotNet.IO.ByteCode.Actions.BaseAction">action objects</see>.
	/// </summary>
	public class Decompiler {
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionConstantPool">constant pool</see> action from swf. the constant pool is not parsed.
		/// </summary>
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionStoreRegister">store register</see> action from swf.
		/// </summary>
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionSetTarget">ActionSetTarget</see> from swf.
		/// </summary>		
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionGotoFrame">ActionGotoFrame</see> from swf.
		/// </summary>		
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionGotoFrame2">ActionGotoFrame2</see> from swf.
		/// </summary>
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionGetUrl">ActionGetUrl</see> from swf.
		/// </summary>
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionGetUrl2">ActionGetUrl2</see> from swf.
		/// </summary>
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionWaitForFrame">ActionWaitForFrame</see> from swf.
		/// </summary>		
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionWaitForFrame2">ActionWaitForFrame2</see> from swf.
		/// </summary>		
		...
		/// <summary>
		/// Read <see cref="SwfDotNet.IO.ByteCode.Actions.ActionWith">ActionWith</see> from swf.
		/// </summary>
		...
		/// <see cref="SwfDotNet.IO.ByteCode.Actions.ActionTry">ActionTry</see>,
		/// <see cref="SwfDotNet.IO.ByteCode.Actions.ActionCatch">ActionCatch</see>,
		/// <see cref="SwfDotNet.IO.ByteCode.Actions.ActionFinally">ActionFinally</see>,
		/// <see cref="SwfDotNet.IO.ByteCode.Actions.ActionEndTryBlock">ActionEndTryBlock</see>
		/// actions.
		/// </summary>
		...
		/// <summary>
		/// Read unknown instruction as <see cref="SwfDotNet.IO.ByteCode.Actions.UnknownAction">UnknownAction</see> object
		/// </summary>		
		...
		/// <summary>
		/// convert <see cref="SwfDotNet.IO.ByteCode.Actions.ActionPushList">push list</see> to sequence of single <see cref="SwfDotNet.IO.ByteCode.Actions.ActionPush" >push</see> actions
		/// </summary>		
		...
		/// <summary>
		/// create <see cref="SwfDotNet.IO.ByteCode.Actions.ActionLabel">ActionLabel</see> pseudo actions for branch labels
		/// </summary>		
