...
namespace SwfDotNet.IO.Tags {
	...
	/// </p>
	/// </remarks>
	public class DefineShapeTag : DefineShape 
	{	
        #region Ctor

        /// <summary>
        /// Creates a new <see cref="DefineShapeTag"/> instance.
        /// </summary>
        public DefineShapeTag()
        {
            this.shapeType = ShapeType.Shape;
            this.versionCompatibility = 1;
            this._tagCode = (int)TagCodeEnum.DefineShape;
        }
		...
		public DefineShapeTag(ushort shapeId, Rect rect, ShapeWithStyle shape)
		...
		{
			writer.WriteStartElement("DefineShapeTag");
