...
namespace SwfDotNet.IO.Utils
{
	...
	public class BufferedBinaryWriter: BinaryWriter
	{
		...
		public BufferedBinaryWriter(Stream stream): this(stream, true)
		{
		}
        ...
        public BufferedBinaryWriter(Stream stream, bool useLittleEndian): base(stream)
        {
            if (useLittleEndian)
        ...
        public BufferedBinaryWriter(Stream stream, Encoding encodingMode): this(stream, encodingMode, true)
        {
        }
        ...
        /// <param name="encodingMode">Encoding mode.</param>
        /// <param name="useLittleEndian">Use little endian.</param>
        public BufferedBinaryWriter(Stream stream, Encoding encodingMode, bool useLittleEndian): base(stream, encodingMode)
        {
            if (useLittleEndian)
                this.bitConverter = EndianBitConverter.Little;
            else
        ...
        public override void Write(char[] chars)
        {
            ...
            IEnumerator enums = chars.GetEnumerator();
            while (enums.MoveNext())
                Write((char)enums.Current);
        }
        ...
        public override void Write(char[] chars, int index, int count)
        {
            ...
            for (int i = index; i < index + count && i < chars.Length; i++)
                Write(chars[i]);
        }
        ...
        public override void Write(byte[] buffer)
        {
            ...
            IEnumerator enums = buffer.GetEnumerator();
            while (enums.MoveNext())
                Write((byte)enums.Current);
        }
