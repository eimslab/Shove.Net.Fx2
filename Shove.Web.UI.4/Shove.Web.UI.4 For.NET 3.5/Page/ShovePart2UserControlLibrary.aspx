<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShovePart2UserControlLibrary.aspx.cs" Inherits="Shove.Web.UI.ShovePart2UserControlLibrary" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ShovePart2用户控件库</title>
    <style type="text/css">
        body
        {
                                    ...
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                            ...
                                            <table width="610" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:GridView HorizontalAlign="Center" PagerStyle-CssClass="blue12" PagerStyle-HorizontalAlign="Center" PagerStyle-BackColor="#FFFFFF" AutoGenerateColumns="False" HeaderStyle-CssClass="black12" BorderWidth="0" CellSpacing="1" CellPadding="0" Width="100%" BackColor="#6CA4E4" HeaderStyle-Height="25" HeaderStyle-BackColor="#E3EEFB" DataKeyNames="ID" AllowPaging="True" OnPageIndexChanging="gvShovePart2UserControls_PageIndexChanging" runat="server" ID="gvShovePart2UserControls">
