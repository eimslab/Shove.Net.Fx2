...
{
    public partial class ShovePart2_AscxAttribute : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ascx = (ShovePart2UserControl)Page.LoadControl(ViewState["AscxFileName"] + "");
        ...
        private void InitLayOut(string controlAttribute)
        {
            ...
            {
                Response.Write("<script type=\"text/javascript\">alert('只有继承于 ShovePart2UserControl 的控件，并且设置了可以编辑的属性，才能编辑其属性！'); window.opener = null; window.returnValue = null; window.close();</script>");
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            this.ClientScript.RegisterClientScriptBlock(GetType(), "ShovePart2_back", str);
        }
