...
namespace Shove.Web.UI
{
    ...
    /// 控件库
    /// </summary>
    public partial class ShoveWebPartUserControlLibrary : System.Web.UI.Page
    {
        ...
        protected System.Web.UI.WebControls.GridView gvShoveWebPartUserControls;
        ...
        private DataSet GetApplicationSet()
        {
            ...
            if (DirPath != "")
            {
                if (DirPath == "ShoveWebPartUserControlsAndTypeDataSet")
                {
                    try
                    {
                        ds = (DataSet)HttpContext.Current.Application[SystemPreFix + "ShoveWebPartUserControlsAndTypeDataSet" + Session["UserID"]];
                    }
                    catch { }
                }
            }
        ...
        private void BindData()
        {
            ...
            if (data != null && data.Tables.Count == 4)
            {
                ...
                gvShoveWebPartUserControls.DataSource = dt;
                gvShoveWebPartUserControls.DataBind();
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void gvShoveWebPartUserControls_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvShoveWebPartUserControls.PageIndex = e.NewPageIndex;
        ...
        protected void tvUserControlsDir_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            gvShoveWebPartUserControls.DataSource = CurrData;
            gvShoveWebPartUserControls.DataBind();
        }
        ...
        protected void ibUserCotrol_Click(object sender, ImageClickEventArgs e)
        {
            ...
            foreach (GridViewRow row in gvShoveWebPartUserControls.Rows)
            {
            ...
            else
            {
                ...
                this.ClientScript.RegisterClientScriptBlock(GetType(), "ShoveWebPart_UserControlFileUrl", str);
            }
        }
    }
}