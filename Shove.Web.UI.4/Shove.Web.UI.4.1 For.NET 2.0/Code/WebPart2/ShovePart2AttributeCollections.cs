...
{
    /// <summary>
    /// ShovePart2 用户控件的属性集合
    /// </summary>
    public class ShovePart2AttributeCollections
    {
        public ArrayList alKey;
        public ArrayList alValue;

        public ShovePart2AttributeCollections()
        {
            alKey = new ArrayList();
        ...
        public void FromString(string AttributesString, ShovePart2UserControl swpuc)
        {
            Clear();
