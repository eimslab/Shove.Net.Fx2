...
namespace Shove.Web.UI
{
    ...
    public class ShoveWebPart : Panel, INamingContainer
    {
        ...
        {
            this.Page.ClientScript.RegisterClientScriptInclude("Shove.Web.UI.ShoveWebPart", "ShoveWebUI_client/Script/Shove.Web.UI.Script.ShoveWebPart.js");
        ...
        [Bindable(false), Category("布局"), DefaultValue(VerticalAlign.Middle), Description("内容垂直对齐")]
        ...
        private short License
        {
            get
            {
                //return LicenseLevel.RunAndDesign;
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            string _VerticalAlign = "vertical-align: " + VerticalAlign.ToString().ToLower() + "; ";
            ...
            string BC = (BackColor.Name == "Window") ? "" : BackColor.Name;

            if (AutoHeight)
            {
                output.AddAttribute(HtmlTextWriterAttribute.Style, _VerticalAlign + "background-color: " + BC + ";position:absolute; border:" + BorderWidth.ToString() + " " + BorderStyle.ToString() + " " + BorderColor.Name + "; top: " + Top.ToString() + "; left: " + Left.ToString() + "; width: " + Width.ToString() + "; height: auto; overflow-x: hidden; overflow-y: visible; z-index: " + ZIndex.ToString());
            }
            else
            {
                output.AddAttribute(HtmlTextWriterAttribute.Style, _VerticalAlign + "background-color: " + BC + "; position:absolute; border:" + BorderWidth.ToString() + " " + BorderStyle.ToString() + " " + BorderColor.Name + "; top: " + Top.ToString() + "; left: " + Left.ToString() + "; width: " + Width.ToString() + "; height: " + Height.ToString() + "; overflow: hidden; z-index: " + ZIndex.ToString());
            }
