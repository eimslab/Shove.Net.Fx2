...
namespace Shove.Web.UI
{
    public partial class ShoveWebPartAttributes : System.Web.UI.Page
    {
        ...
        //-----------
        protected System.Web.UI.WebControls.DropDownList ddlFloat;

        protected System.Web.UI.WebControls.TextBox tbMarginLeftOrRight;
        protected System.Web.UI.WebControls.TextBox tbMarginVertical;
        ...
        //--------
        public string Attrib_Float = "";
        public string Attrib_MarginLeftOrRight = "";
        public string Attrib_MarginVertical = "";
        //---------
        ...
        {
            if (this.Session["Shove.Web.UI.ShoveWebPart.RunMode"]!=null && this.Session["Shove.Web.UI.ShoveWebPart.RunMode"].ToString() != "DESIGN")
            {
            ...
            if (!IsPostBack)
            {
                ...
                //--------------
                Attrib_Float = System.Web.HttpUtility.UrlDecode(this.Request["Float"]);
                Attrib_MarginVertical = System.Web.HttpUtility.UrlDecode(this.Request["MarginVertical"]);
                Attrib_MarginLeftOrRight = System.Web.HttpUtility.UrlDecode(this.Request["MarginLeftOrRight"]);
                //---------------
                ...
                if (Attrib_MarginVertical == "")
                {
                    Attrib_MarginVertical = "0px";
                }

                if (Attrib_MarginLeftOrRight == "")
                {
                    Attrib_MarginLeftOrRight = "0px";
                }
                //-----------
                ...
                //--------------------
                ViewState["Attrib_Float"] = Attrib_Float;
                ViewState["Attrib_MarginVertical"] = Attrib_MarginVertical;
                ViewState["Attrib_MarginLeftOrRight"] = Attrib_MarginLeftOrRight;
            ...
            else
            {
                ...
                //--------------
                Attrib_Float = ViewState["Attrib_Float"]+"";
                Attrib_MarginVertical = ViewState["Attrib_MarginVertical"] +"" ;
                Attrib_MarginLeftOrRight = ViewState["Attrib_MarginLeftOrRight"]+"" ;
        ...
        private void BindData()
        {
            ...
            //-----------------------------
            ddlFloat.Items.Clear();
            ddlFloat.Items.Add(new ListItem("不浮动", "none"));
            ddlFloat.Items.Add(new ListItem("左浮动","left"));
            ddlFloat.Items.Add(new ListItem("右浮动", "right"));
            ddlFloat.Items.Add(new ListItem("继承", "inherit"));       

            ControlExt.SetDownListBoxTextFromValue(ddlFloat, Attrib_Float);

            tbMarginLeftOrRight.Text = Attrib_MarginLeftOrRight;
            tbMarginVertical.Text = Attrib_MarginVertical;
            //------------------------------
