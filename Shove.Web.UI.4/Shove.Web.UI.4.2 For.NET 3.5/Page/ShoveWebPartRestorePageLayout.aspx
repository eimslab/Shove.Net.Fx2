<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShoveWebPartRestorePageLayout.aspx.cs" Inherits="Shove.Web.UI.ShoveWebPartRestorePageLayout" %>
            ...
            <tr>
                <td height="48" valign="bottom">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="right">
                                <asp:ImageButton ImageUrl="../Images/top_botton_4.jpg" runat="server" ID="btnResumption" OnClick="btnResumption_Click" />
                            </td>
                            <td align="center">
                                <asp:ImageButton ImageUrl="../Images/top_botton_5.jpg" runat="server" ID="btnDelete" OnClick="btnDelete_Click" />
                            </td>
                            <td align="left">
