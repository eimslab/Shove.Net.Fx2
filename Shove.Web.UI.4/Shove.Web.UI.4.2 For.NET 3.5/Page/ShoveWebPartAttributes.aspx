<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShoveWebPartAttributes.aspx.cs" Inherits="Shove.Web.UI.ShoveWebPartAttributes" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    function btnOK_onclick()
    {
        ...
        //-----------------
        var o_ddlFloat=document.getElementById("ddlFloat");
        var o_tbMarginLeftOrRight=document.getElementById("tbMarginLeftOrRight");
        var o_tbMarginVertical=document.getElementById("tbMarginVertical");
        //---------------------
    ...
    //----------------------
        var MarginLeftOrRight=parseInt(o_tbMarginLeftOrRight.value.replace("px",""),10)+"px";
        if (MarginLeftOrRight == "NaNpx")
        {
            MarginLeftOrRight="0px";
        }
        var MarginVertical=parseInt(o_tbMarginVertical.value.replace("px",""),10)+"px";
        if (MarginVertical == "NaNpx")
        {
            MarginVertical="0px";
        }
    //----------------------------
        ...
        ReturnParams.AddToNoExistPage = o_cbAddToNoExistPage.checked ? "True" : "False";
         //-----------
        ReturnParams.Float=o_ddlFloat.value;
        ReturnParams.MarginLeftOrRight=MarginLeftOrRight;
        ReturnParams.MarginVertical=MarginVertical;
...
<body style="margin: 0px; background-color: buttonface;">
    ...
    <div>
        ...
        <asp:Label ID="Label12" runat="server" Style="z-index: 2; left: 15px;position: absolute;  top: 75px;display:none;" Text="定位－左：" ></asp:Label>
        <asp:Label ID="Label13" runat="server" Style="z-index: 2; left: 136px;position: absolute;  top: 75px;display:none;" Text="定位－顶：" ></asp:Label>
        <asp:TextBox ID="tbTop" runat="server" Style="z-index: 4; left: 202px;position: absolute;  top: 73px;display:none;" Width="40px" Enabled="false" ></asp:TextBox>
        <asp:Label ID="Label14" runat="server" Style="z-index: 2; left: 15px; position: absolute;top: 75px" Text="定位－宽："></asp:Label>
        <asp:TextBox ID="tbWidth" runat="server" Style="z-index: 4; left: 81px; position: absolute; top: 73px" Width="40px"></asp:TextBox>
        <asp:Label ID="Label15" runat="server" Style="z-index: 2; left: 136px; position: absolute; top: 75px" Text="定位－高："></asp:Label>
        <asp:TextBox ID="tbHeight" runat="server" Style="z-index: 4; left: 202px; position: absolute; top: 73px" Width="40px"></asp:TextBox>
        <asp:TextBox ID="tbLeft" runat="server" Style="z-index: 4; left: 81px; display:none; top: 73px" Width="40px" Enabled="false" ></asp:TextBox>
        ...
        <asp:CheckBox ID="cbAutoHeight" runat="server" Text="自适应高度" Style="z-index: 25; position: absolute; left: 258px; top: 74px;" Width="84px" />
        ...
        <asp:Label ID="Label18" runat="server" Style="z-index: 25; left: 340px; position: absolute; top: 74px" Text="浮动："></asp:Label>
        <asp:DropDownList ID="ddlFloat" runat="server" Style="z-index: 25; left: 370px; position: absolute; top: 74px;" Width="80px">
        </asp:DropDownList>
        <asp:Label ID="Label19" runat="server" Style="z-index: 25; left: 460px; position: absolute; top: 74px" Text="水平偏移："></asp:Label>
        <asp:TextBox ID="tbMarginLeftOrRight" runat="server" Style="z-index: 25; left:520px; position: absolute; top: 74px;" Width="40px"></asp:TextBox>
        
        <asp:Label ID="Label24" runat="server" Style="z-index: 25; left: 570px; position: absolute; top: 74px" Text="垂直偏移："></asp:Label>
        <asp:TextBox ID="tbMarginVertical" runat="server" Style="z-index: 25; left: 630px; position: absolute; top: 74px;" Width="40px"></asp:TextBox>
