...
namespace Shove.Web.UI
{
    ...
    //public  class ShoveWebPartFile
    {
        ...
        //        Result.Append("<div runat=\"server\" class=\"dragLayer\" ShoveWebUITypeName=\"ShoveWebPart\" OffsetLeft=\"" + ((ParentLeft.ToString() == "") ? "0px" : ParentLeft.ToString()) + "\" ");
        ...
        public string BuildShoveWebPartContent(DataTable dtParts, string divlayout, ref string RegisterUserControlTagName)
        {
            RegisterUserControlTagName = "";
        ...
        public DataTable Read(string OtherFileName, string ShoveWebPartID, ref int RowNo)
        {
            ...
            if (dtParts == null)
            {
                ...
                string strRegex = @"<div runat=""server"" class=""dragLayer"" ShoveWebUITypeName=""ShoveWebPart"" OffsetLeft=""(?<L0>[^""]*)"" PrimitiveHeight=""(?<L1>[^""]*)""";
        ...
        public void Write(DataTable dtParts, string OtherFileName)
        {
            ...
            string ShoveWebPartContent = BuildShoveWebPartContent(dtParts, LayoutDiv, ref RegisterUserControlTagName);
        ...
        public void BackupSite()
        {
            ...
            //备份站点页面布局文件ini
            string IniFileName = System.AppDomain.CurrentDomain.BaseDirectory + "/Private/" + SiteID.ToString() + "/ShoveWebPartLayout.ini";

            if (!System.IO.File.Exists(IniFileName))
            {
                return;
            }
            string iniTargetFileName = System.AppDomain.CurrentDomain.BaseDirectory + "/Private/" + SiteID.ToString() + "/PageCaches/Backup/Site/" + NewBackupFileName + "/ShoveWebPartLayout.ini.bak";
        ...
        public void RestoreSite(string BackupDirectoryName)
        {
            ...
            string iniFileName = System.AppDomain.CurrentDomain.BaseDirectory + "/Private/" + SiteID.ToString() + "/ShoveWebPartLayout.ini";
            string backupiniFileName = BackupDirectoryName + "/ShoveWebPartLayout.ini.bak";
        ...
        public void DeleteSite()
        {
            ...
            //删除ini页面布局文件
            string FileName = System.AppDomain.CurrentDomain.BaseDirectory + "/Private/" + SiteID.ToString() + "/ShoveWebPartLayout.ini";
        ...
        public void DeletePage()
        {
            ...
            IniFile ini = new IniFile(System.AppDomain.CurrentDomain.BaseDirectory + "/Private/" + SiteID.ToString() + "/ShoveWebPartLayout.ini");
