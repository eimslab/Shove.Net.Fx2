...
namespace Shove.Web.UI
{
    ...
    public class ShoveGridPagerSinglePageQuery : WebControl, INamingContainer, IPostBackEventHandler
    {
        ...
        public ShoveGridPagerSinglePageQuery()
        {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            this._DataGrid = g;
            this._DataGrid.AllowPaging = false;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            string[] textArray = new string[] { "页次:", (this.PageIndex + 1).ToString(), "/", this.PageCount.ToString(), " 每页", this.PageSize.ToString(), "条 共", this.ReportCount.ToString(), "条" };
            ...
            if (this.ShowButton)
            {
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Title, "第一页");
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Title, "上一组");
                writer.RenderBeginTag(HtmlTextWriterTag.A);
                writer.Write(7);
                writer.RenderEndTag();
                writer.Write("\r\n");
                ...
                for (int i = 1; i <= this.ButtonCount; i++)
                {
                    if (((this.CurrentGroup * this.ButtonCount) + i) <= this.PageCount)
                    {
                        ...
                        writer.AddAttribute(HtmlTextWriterAttribute.Title, "第" + (((this.CurrentGroup * this.ButtonCount) + i)).ToString() + "页");
                        writer.RenderBeginTag(HtmlTextWriterTag.A);
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Title, "下一组");
                writer.RenderBeginTag(HtmlTextWriterTag.A);
                writer.Write(8);
                writer.RenderEndTag();
                writer.Write("\r\n");
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Title, "最后一页");
                writer.RenderBeginTag(HtmlTextWriterTag.A);
                writer.Write(":");
                writer.RenderEndTag();
                writer.Write("\r\n");
            ...
            if (this.ShowDropDownList)
            {
                ...
                writer.RenderBeginTag(HtmlTextWriterTag.Td);
                writer.Write("\r\n");
                writer.AddAttribute(HtmlTextWriterAttribute.Title, "选择页数");
        ...
        public int PageCount
        {
            get
            {
                object obj2 = this.ViewState["_PageCount"];
        ...
        public int ReportCount
        {
            get
            {
                object obj2 = this.ViewState["_ReportCount"];
            ...
            set
            {
                this.ViewState["_ReportCount"] = value;
            }
        }
