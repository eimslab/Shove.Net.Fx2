...
namespace Shove.Web.UI
{
    ...
    /// 页面布局备份、恢复
    /// </summary>
    public partial class ShovePart2RestorePageLayout : System.Web.UI.Page
    {
        ...
        {
            if (this.Session["Shove.Web.UI.ShovePart2.RunMode"] == null)
            {
                this.Response.Write("当前非设计模式。");
                this.Response.End();
        ...
        private void BindData(string SiteID, string PageName)
        {
            ...
            foreach (FileInfo file in files)
            {
                ...
                //TreeNode node = new TreeNode(file.Name, file.Name);
        ...
        protected void btnResumption_Click(object sender, EventArgs e)
        {
            ...
            string BackupFileName = nodes[0].Text;
