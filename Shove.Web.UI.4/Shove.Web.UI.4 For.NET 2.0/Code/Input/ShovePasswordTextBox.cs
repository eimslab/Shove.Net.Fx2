...
namespace Shove.Web.UI
{
    ...
    public class ShovePasswordTextBox : TextBox
    {
        ...
        {
            this.Page.ClientScript.RegisterClientScriptInclude("Shove.Web.UI.ShovePasswordTextBox", this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "Shove.Web.UI.Script.ShovePasswordTextBox.js"));
