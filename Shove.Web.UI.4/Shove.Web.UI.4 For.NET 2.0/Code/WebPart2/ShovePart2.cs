    ...
    public class ShovePart2 : Panel, INamingContainer
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            if (License == LicenseLevel.None && (HttpContext.Current.Request.Url.AbsoluteUri).IndexOf("http://localhost:") < 0)
            {
                ...
                output.WriteLine("ShovePart2 组件已过期，请联系开发商<a href=\"" + SupportDir + "/Page/ShovePart2License.aspx?LastRequestPage=" + HttpUtility.UrlEncode(this.Page.Request.Url.AbsoluteUri) + "\">获取最新的授权</a>，谢谢！<br />");
            ...
            base.RenderChildren(output); //输出控件内容
